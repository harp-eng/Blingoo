                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("deliverytimeslot::text.name")
                            </th>
                            <th>
                                @lang("deliverytimeslot::text.slug")
                            </th>
                            <th>
                                @lang("deliverytimeslot::text.updated_at")
                            </th>
                            <th>
                                @lang("deliverytimeslot::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("deliverytimeslot::text.action")
                            </th>
                        </tr>
                    </thead>
