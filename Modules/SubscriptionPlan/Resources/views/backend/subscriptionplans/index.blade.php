                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("subscriptionplan::text.name")
                            </th>
                            <th>
                                @lang("subscriptionplan::text.slug")
                            </th>
                            <th>
                                @lang("subscriptionplan::text.updated_at")
                            </th>
                            <th>
                                @lang("subscriptionplan::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("subscriptionplan::text.action")
                            </th>
                        </tr>
                    </thead>
