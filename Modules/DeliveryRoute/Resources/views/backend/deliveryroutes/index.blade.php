                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("deliveryroute::text.name")
                            </th>
                            <th>
                                @lang("deliveryroute::text.slug")
                            </th>
                            <th>
                                @lang("deliveryroute::text.updated_at")
                            </th>
                            <th>
                                @lang("deliveryroute::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("deliveryroute::text.action")
                            </th>
                        </tr>
                    </thead>
